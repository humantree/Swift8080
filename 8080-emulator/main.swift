...
while true {
  ...
  switch byte {
  case 0x00: unimplementedInstruction(instruction: byte)
  ...
  case 0x08: unimplementedInstruction(instruction: byte)
  ...
  case 0x10: unimplementedInstruction(instruction: byte)
  ...
  case 0x18: unimplementedInstruction(instruction: byte)
  ...
  case 0x28: unimplementedInstruction(instruction: byte)
  ...
  case 0x38: unimplementedInstruction(instruction: byte)
  ...
  case 0xCB: unimplementedInstruction(instruction: byte)
  ...
  case 0xD9: unimplementedInstruction(instruction: byte)
  ...
  case 0xDD: unimplementedInstruction(instruction: byte)
  ...
  case 0xED: unimplementedInstruction(instruction: byte)
  ...
  case 0xFD: unimplementedInstruction(instruction: byte)
