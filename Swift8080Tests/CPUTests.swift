...
class CPUTests: XCTestCase {
  ...
  func testCALL() {
    memory[0xE0] = Opcode.MOV_A_B.rawValue
    memory[0xE1] = Opcode.RET.rawValue
    memory[0xE2] = Opcode.MOV_A_C.rawValue

    memory[0xF0] = Opcode.CALL.rawValue
    memory[0xF1] = 0xE0
    memory[0xF2] = 0x00
  ...
  func testCC1() {
    ...
    memory[0xF0] = Opcode.CC.rawValue
    memory[0xF1] = 0xE0
    memory[0xF2] = 0x00
  ...
  func testCM1() {
    ...
    memory[0xF0] = Opcode.CM.rawValue
    memory[0xF1] = 0xE0
    memory[0xF2] = 0x00
  ...
  func testCNC1() {
    ...
    memory[0xF0] = Opcode.CNC.rawValue
    memory[0xF1] = 0xE0
    memory[0xF2] = 0x00
  ...
  func testCNZ1() {
    ...
    memory[0xF0] = Opcode.CNZ.rawValue
    memory[0xF1] = 0xE0
    memory[0xF2] = 0x00
  ...
  func testCP1() {
    ...
    memory[0xF0] = Opcode.CP.rawValue
    memory[0xF1] = 0xE0
    memory[0xF2] = 0x00
  ...
  func testCPE1() {
    ...
    memory[0xF0] = Opcode.CPE.rawValue
    memory[0xF1] = 0xE0
    memory[0xF2] = 0x00
  ...
  func testCPO1() {
    ...
    memory[0xF0] = Opcode.CPO.rawValue
    memory[0xF1] = 0xE0
    memory[0xF2] = 0x00
  ...
  func testCZ1() {
    ...
    memory[0xF0] = Opcode.CZ.rawValue
    memory[0xF1] = 0xE0
    memory[0xF2] = 0x00
